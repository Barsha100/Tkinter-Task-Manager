...
# Add color coding to buttons
add_button = tk.Button(button_frame, text="Add Task", command=add_task, width=12, bg="green", fg="white")
edit_button = tk.Button(button_frame, text="Edit Task", command=edit_task, width=12, bg="blue", fg="white")
delete_button = tk.Button(button_frame, text="Delete Task", command=delete_task, width=12, bg="red", fg="white")
complete_button = tk.Button(button_frame, text="Mark Complete", command=mark_complete, width=12, bg="yellow", fg="black")
exit_button = tk.Button(button_frame, text="Exit", command=exit_app, width=12, bg="gray", fg="white")
